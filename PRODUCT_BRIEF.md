...
Mixer is a simple music-mixing tool for reviving archival recordings and historic music. A user drags in a main track, adds beats from a beat library, and quickly creates a fresh version of an old or overlooked recording.
...
There is a large body of archival audio, historic music, field recordings, and older tracks that feels culturally rich but inaccessible to modern listeners. Mixer gives creators a lightweight way to reintroduce that material by pairing it with contemporary beats and simple mixing controls.
...
Mixer should start as a SaaS web app. The web is the fastest way to support accounts, cloud libraries, saved projects, sharing, and listening across devices without asking non-technical users to install production software.
...
Mixer should distinguish between music that is available to stream, music that is safe to remix, and music that can be commercially reused.
...
Archive of Indian Music is especially aligned with Mixer's mission because it preserves gramophone recordings of India across Hindustani classical, Carnatic classical, theatre, early cinema, folk, and other traditions. However, AIM's website currently states that tracks are streaming-only unless otherwise mentioned, and that download or commercial misuse is prohibited. Mixer should not treat AIM as a default remixable source without explicit permission or a partnership.
...
Mixer is for people who want to make old music feel new again.
...
- Should Mixer ship with sample archival tracks and beat packs, or should users bring all content themselves?
...
- Would Archive of Indian Music or similar archives be open to a remix-focused partnership, or should Mixer only link out for listening?
